...
;// CONCATENATED MODULE: ./src/js/Сard.js
class Card {
  constructor() {
    this.deleteButton = [];
    this.textBox = [];
  ...
  addProection(textBoxList, mouseUpItem) {
    if (mouseUpItem && mouseUpItem.classList.contains("textBox") && !mouseUpItem.classList.contains("proectionAdded")) {
  ...
  addListner() {
    this.textBox.forEach(element => element.addEventListener("mouseover", element => {
    ...
    this.cards.forEach(element => element.addEventListener("mousedown", element => {
    ...
    this.textBox.forEach(element => element.addEventListener("mouseout", element => {
      const parent = element.target.closest(".textBox");
      parent.querySelector(".deleteButton").style.display = "none";
    }));
    this.deleteButton.forEach(element => element.addEventListener("click", e => {
